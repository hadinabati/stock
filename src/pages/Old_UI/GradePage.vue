<template>
  <h5 class="headers">ثبت و تغییرات درجات نظامی</h5>
  <hr style="width: 50%">
  <div class="row q-mt-lg">
    <div class="col-md-6" style="border-left: 1px dashed black ; height: 80vh">
      <p class="text">ثبت درجه</p>
      <div class="full-width q-mt-lg">
        <label class="labels">نام درجه</label>
      ...
      <div class="full-width q-mt-lg">
        <q-btn class="inputs" color="indigo-10" @click="save" label="ثبت درجه"></q-btn>
      </div>
  ...
  methods: {
    save() {
      if (this.Position.name !== '' && this.Position.description !== '') {
        const address = new urls()
        axios.post(address.Grade_create(), {
    ...
    updated() {
      if (this.Update.new_name !== '' && this.Update.new_description !== '') {
        const address = new urls()
        axios.put(address.Grade_update(), {
